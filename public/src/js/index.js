...
gameContainer.style.background = "url('../src/images/background-day.png')";
...
baseContainer.style.background = "url('../src/images/base.png')";
...
class Bird{
    ...
    create(){
        ...
        this.element.style.background = "url('../src/images/bluebird-downflap.png')";
